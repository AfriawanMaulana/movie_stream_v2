                ...
                {data?.results.map((item) => {
                    ...
                    return (
                        <div key={item.id} className="flex flex-col space-y-2 h-60 md:h-80">
                            <Link href={`/${category}/${slugify(item.title || item.name)}?id=${item.id}`} className="group w-full h-full relative overflow-hidden rounded-xl">
                                <Image 
                            ...
                            <div>
                                <Link href={`/${category}/${slugify(item.title || item.name)}?id=${item.id}`} className="text-sm hover:text-red-500">
